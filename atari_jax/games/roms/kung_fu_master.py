...
"""Kung-Fu Master — reward and terminal extraction, plus reset/step entry points."""
...
# Source: Arcade-Learning-Environment src/ale/games/supported/KungFuMaster.cpp
# Score: getDecimalScore(0x9A, 0x99, 0x98) — lower/middle/higher packed BCD bytes.
SCORE_LO = 0x9A  # ones and tens
SCORE_MID = 0x99  # hundreds and thousands
SCORE_HI = 0x98  # ten-thousands and hundred-thousands
LIVES_ADDR = 0x9D  # lower 3 bits hold lives − 1; 0xFF is the game-over sentinel


class KungFuMaster(AtariGame):
    """Kung-Fu Master game logic: reward and terminal extraction, reset, and step.

    Terminal when RAM[0x9D] equals 0xFF (underflow game-over sentinel).
    """
    ...
    def get_lives(self, ram: chex.Array) -> chex.Array:
        ...
        -------
        lives : chex.Array
            int32 — Lives remaining ((RAM[0x9D] & 0x7) + 1; 0 on sentinel 0xFF).
        """
        byte = ram[LIVES_ADDR]
