...
_GAMES: list[GameSpec] = [
    ...
    GameSpec(game_id=1, ale_name="alien", game=Alien()),
    GameSpec(game_id=2, ale_name="amidar", game=Amidar()),
    GameSpec(game_id=3, ale_name="assault", game=Assault()),
    GameSpec(game_id=4, ale_name="asterix", game=Asterix()),
    GameSpec(game_id=5, ale_name="asteroids", game=Asteroids()),
    GameSpec(game_id=6, ale_name="atlantis", game=Atlantis()),
    GameSpec(game_id=7, ale_name="bank_heist", game=BankHeist()),
    GameSpec(game_id=8, ale_name="battle_zone", game=BattleZone()),
    GameSpec(game_id=9, ale_name="beam_rider", game=BeamRider()),
    GameSpec(game_id=10, ale_name="berzerk", game=Berzerk()),
    GameSpec(game_id=11, ale_name="bowling", game=Bowling()),
    GameSpec(game_id=12, ale_name="boxing", game=Boxing()),
