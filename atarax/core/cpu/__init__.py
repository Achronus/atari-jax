...
from atarax.core.cpu._helpers import _op_undef
from atarax.core.cpu._ops_alu import (
    _op_adc_abs,
    _op_adc_absx,
    _op_adc_absy,
    _op_adc_imm,
...
from atarax.core.cpu._ops_branch import (
    _op_bcc,
    _op_bcs,
    _op_beq,
    _op_bmi,
...
from atarax.core.cpu._ops_control import (
    _op_brk,
    _op_clc,
    _op_cld,
    _op_cli,
...
from atarax.core.cpu._ops_load_store import (
    _op_lda_abs,
    _op_lda_absx,
    _op_lda_absy,
    _op_lda_imm,
