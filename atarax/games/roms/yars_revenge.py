...
"""Yar's Revenge — reward and terminal extraction, plus reset/step entry points."""
...
# Source: Arcade-Learning-Environment src/ale/games/supported/YarsRevenge.cpp
# Score: getDecimalScore(0xE2, 0xE1, 0xE0) — lower/middle/higher packed BCD bytes.
SCORE_LO = 0xE2  # ones and tens
SCORE_MID = 0xE1  # hundreds and thousands
SCORE_HI = 0xE0  # ten-thousands and hundred-thousands
LIVES_ADDR = 0x9E  # upper nibble holds 0-based lives count; terminal when 0


class YarsRevenge(AtariGame):
    """Yar's Revenge game logic: reward and terminal extraction, reset, and step."""
    ...
    def get_lives(self, ram: chex.Array) -> chex.Array:
        ...
        -------
        lives : chex.Array
            int32 — Lives remaining (RAM[0x9E] >> 4; 0-based).
        """
    ...
    def is_terminal(self, ram: chex.Array, lives_prev: chex.Array) -> chex.Array:
        ...
        Terminal when the upper nibble of RAM[0x9E] equals 0.
        ...
        """
        return (ram[LIVES_ADDR] >> jnp.uint8(4)) == jnp.uint8(0)
