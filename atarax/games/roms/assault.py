...
"""Assault — reward and terminal extraction, plus reset/step entry points."""
...
# Source: Arcade-Learning-Environment src/ale/games/supported/Assault.cpp
...
LIVES_ADDR = 0xE5  # lives remaining (full byte)


class Assault(AtariGame):
    """Assault game logic: reward and terminal extraction, reset, and step."""
