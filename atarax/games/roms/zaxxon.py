...
"""Zaxxon — reward and terminal extraction, plus reset/step entry points."""
...
# Source: Arcade-Learning-Environment src/ale/games/supported/Zaxxon.cpp
# Score: getDecimalScore(0xE9, 0xE8) * 100 — lower/higher 2-byte BCD × 100.
SCORE_LO = 0xE9  # ones and tens (of hundreds)
SCORE_HI = 0xE8  # hundreds and thousands (of hundreds)
LIVES_ADDR = 0xEA  # lower 3 bits hold 0-based lives count; 0 = terminal


class Zaxxon(AtariGame):
    """Zaxxon game logic: reward and terminal extraction, reset, and step.

    Score is 2-byte packed BCD × 100.  Terminal when (RAM[0xEA] & 0x7) equals 0.
    """
    ...
    def get_lives(self, ram: chex.Array) -> chex.Array:
        ...
        -------
        lives : chex.Array
            int32 — Lives remaining (RAM[0xEA] & 0x7; 0-based).
        """
    ...
    def is_terminal(self, ram: chex.Array, lives_prev: chex.Array) -> chex.Array:
        ...
        Terminal when (RAM[0xEA] & 0x7) equals 0.
