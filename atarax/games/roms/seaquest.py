...
"""Seaquest — reward and terminal extraction, plus reset/step entry points."""
...
# Source: Arcade-Learning-Environment src/ale/games/supported/Seaquest.cpp
# Score: getDecimalScore(0xBA, 0xB9, 0xB8) — lower/middle/higher packed BCD bytes.
SCORE_LO = 0xBA  # ones and tens
SCORE_MID = 0xB9  # hundreds and thousands
SCORE_HI = 0xB8  # ten-thousands and hundred-thousands
LIVES_ADDR = 0xBB  # lives stored 0-based; actual lives = RAM[0xBB] + 1
TERM_ADDR = 0xA3  # non-zero when the episode has ended


class Seaquest(AtariGame):
    """Seaquest game logic: reward and terminal extraction, reset, and step."""
    ...
    def get_lives(self, ram: chex.Array) -> chex.Array:
        ...
        -------
        lives : chex.Array
            int32 — Lives remaining (RAM[0xBB] + 1).
        """
    ...
    def is_terminal(self, ram: chex.Array, lives_prev: chex.Array) -> chex.Array:
        ...
        Terminal when RAM[0xA3] is non-zero.
