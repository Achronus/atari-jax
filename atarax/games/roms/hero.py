...
"""H.E.R.O. — reward and terminal extraction, plus reset/step entry points."""
...
# Source: Arcade-Learning-Environment src/ale/games/supported/Hero.cpp
# Score: getDecimalScore(0xB9, 0xB8, 0xB7) — lower/middle/higher packed BCD bytes.
SCORE_LO = 0xB9  # ones and tens
SCORE_MID = 0xB8  # hundreds and thousands
SCORE_HI = 0xB7  # ten-thousands and hundred-thousands
LIVES_ADDR = 0xB3  # raw lives counter


class Hero(AtariGame):
    """H.E.R.O. game logic: reward and terminal extraction, reset, and step."""
    ...
    def get_lives(self, ram: chex.Array) -> chex.Array:
        ...
        -------
        lives : chex.Array
            int32 — Lives remaining (RAM[0xB3] directly).
        """
    ...
    def is_terminal(self, ram: chex.Array, lives_prev: chex.Array) -> chex.Array:
        ...
        Terminal when RAM[0xB3] (lives) equals 0.
        ...
        lives_prev : chex.Array
            int32 — Lives count from before the step (unused; lives-zero detection).
