...
"""Beam Rider — reward and terminal extraction, plus reset/step entry points."""
...
# Source: Arcade-Learning-Environment src/ale/games/supported/BeamRider.cpp
# Score: getDecimalScore(9, 10, 11) — lower/middle/higher packed BCD bytes.
SCORE_LO = 0x09  # ones and tens
SCORE_MID = 0x0A  # hundreds and thousands
SCORE_HI = 0x0B  # ten-thousands and hundred-thousands
LIVES_ADDR = 0x85  # lives stored 0-based; actual lives = RAM[0x85] + 1
TERMINAL_ADDR = 0x05  # 0xFF signals game over


class BeamRider(AtariGame):
    """Beam Rider game logic: reward and terminal extraction, reset, and step."""
    ...
    def get_lives(self, ram: chex.Array) -> chex.Array:
        ...
        -------
        lives : chex.Array
            int32 — Lives remaining (RAM[0x85] + 1).
        """
    ...
    def is_terminal(self, ram: chex.Array, lives_prev: chex.Array) -> chex.Array:
        ...
        Terminal when RAM[0x05] equals 0xFF (game-over sentinel).
        ...
        """
        return ram[TERMINAL_ADDR] == jnp.uint8(0xFF)
