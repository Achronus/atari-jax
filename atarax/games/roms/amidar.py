...
"""Amidar — reward and terminal extraction, plus reset/step entry points."""
...
# Source: Arcade-Learning-Environment src/ale/games/supported/Amidar.cpp
# Score: getDecimalScore(0xD9, 0xDA, 0xDB) — lower/middle/higher packed BCD bytes.
SCORE_LO = 0xD9  # ones and tens
SCORE_MID = 0xDA  # hundreds and thousands
SCORE_HI = 0xDB  # ten-thousands and hundred-thousands
LIVES_ADDR = 0xD6  # low nibble holds lives; 0x80 is the game-over sentinel


class Amidar(AtariGame):
    """Amidar game logic: reward and terminal extraction, reset, and step."""
    ...
    def get_lives(self, ram: chex.Array) -> chex.Array:
        ...
        -------
        lives : chex.Array
            int32 — Lives remaining (low nibble of 0xD6).
        """
    ...
    def is_terminal(self, ram: chex.Array, lives_prev: chex.Array) -> chex.Array:
        ...
        The episode is terminal when the lives byte equals 0x80 (game-over sentinel).
        ...
        """
        return ram[LIVES_ADDR] == jnp.uint8(0x80)
